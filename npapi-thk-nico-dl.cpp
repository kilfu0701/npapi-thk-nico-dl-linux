...
extern char APP_LOCAL[260];
//extern char VLOG_PATH[260];
extern char COOKIE_PATH[260];
extern char NICODLM_APP_PATH[260];
...
char *NP_GetMIMEDescription(void) {
  return (char *)"application/x-thk-nico-dl::Chrome extensions for Nico Download Manager (NicoDLM);";
}

NPError NP_GetValue(void *instance, NPPVariable variable, void *value) {
  switch(variable) {
    case NPPVpluginNameString: {
      *((char **)value) = (char *)"Nico Download Manager Plugins";
      break;
    }
    case NPPVpluginDescriptionString: {
      *((char **)value) = (char *)"Plugin to allow Chrome extensions to manage niconico download.";
      break;
    }
    default: {
...
bool InvokeJavascript_NoArgs(NPObject *npobj, const char *methodName, NPVariant *&result) {
  ...
  } else if (!strcmp(methodName, "selectFolder")) {

  } else if (!strcmp(methodName, "getAppDir")) {
